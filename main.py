...
num_tests = 15
num_students_miss_0_tests = 10
num_students_miss_1_tests = 10
num_students_miss_5_tests = 10
num_students_miss_6_tests = 10



data = pd.DataFrame()
data['# of tests missed'] = [0,1,5,6]
...
for semester in range(num_semesters):
    ...
    data['Semester '+ str(semester)] = [SF.get_group_average(students0), SF.get_group_average(students1), SF.get_group_average(students5), SF.get_group_average(students6)]
